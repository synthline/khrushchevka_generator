...
def generate_combinations(area_A, area_S):
    def generate_new_area(area, direction):
        a, b, c, d = area
        if direction == 'N':
            return (b, (b[0], b[1] + 4000), (c[0], c[1] + 4000), c)
        elif direction == 'E':
            return (c, (c[0] + 2000, c[1]), (c[0] + 2000, c[1] - 4000), d)
        elif direction == 'S':
            return (d, (d[0], d[1] - 4000), (a[0], a[1] - 4000), a)
        elif direction == 'W':
            return (a, (a[0] - 2000, a[1]), (a[0] - 2000, a[1] + 4000), b)
